let MyString = 'Lorem ipsum dolor sit amet consectetur adipiscing elit. Quisque faucibus ex sapien vitae pellentesque sem placerat. In id cursus mi pretium tellus duis convallis. LinkMark<a href="harmonic-collection-entry-1.html">entry-1</a>LinkMark leo eu aenean sed diam urna tempor. Pulvinar vivamus fringilla lacus nec metus bibendum egestas. Iaculis massa nisl malesuada lacinia integer nunc posuere. Fusce LinkMark<a href="harmonic-collection-entry-2.html">entry-2</a>LinkMark diam quis suscipit consequat. Donec in faucibus ligula. Fusce laoreet congue neque, sit amet rhoncus augue convallis quis. Nam sed porta tortor.  Morbi commodo auctor elementum. Vestibulum ante ipsum primis in faucibus orci LinkMark<a href="harmonic-collection-entry-3.html">entry-3</a>LinkMark luctus et ultrices posuere cubilia curae; Maecenas lobortis, magna vitae malesuada volutpat, turpis augue iaculis risus, ut porta velit magna vitae libero. Proin condimentum efficitur velit, vitae convallis mi ullamcorper ut. Aliquam imperdiet malesuada accumsan. Mauris LinkMark<a href="harmonic-collection-entry-4.html">entry-4</a>LinkMark vel ipsum sed rhoncus. Aliquam vulputate vel tellus non maximus. In purus felis, lacinia quis elit eu, faucibus rutrum libero. Integer a justo commodo, gravida velit amet, commodo nibh.';
...
function typenext(){
    ...
    if(PartsIteration < PartsArrayLength){
        let typeTimeout = setTimeout(function(){typenext()},5);
    }
